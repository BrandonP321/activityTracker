...
const currentEnv = EnvUtils.getCurrentEnvironment();
...
export const MasterConfig = (typeof currentEnv === "string" && allConfigs[currentEnv]) ? allConfigs[currentEnv] : allConfigs["live"];
